  ...
  return (
    <div id='skills' className='w-[90%] m-auto h-screen p-2 py-16 pb-0 pt-32 mt-32'>
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        <p className='text-xl tracking-widest uppercase text-[#67E8F9]'>Skills</p>
        <h2 className='py-4'>What I Can Do</h2>
        <div className='grid md:grid-cols-1 lg:grid-cols-1 md:gap-12 gap-6'>
          <div className='p-2 sm:p-4 shadow-lg shadow-[#67E8F9] rounded-xl hover:scale-105 ease-in duration-300'>
